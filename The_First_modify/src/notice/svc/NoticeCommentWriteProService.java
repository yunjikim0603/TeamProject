...
public class NoticeCommentWriteProService {
	
	public boolean registComment(NoticeCommentBean commentBean) {
...
//		Connection con = JdbcUtil.getConnection(); // static 메서드 호출 시
		...
		int insertCount = noticeDAO.insertComment(commentBean);

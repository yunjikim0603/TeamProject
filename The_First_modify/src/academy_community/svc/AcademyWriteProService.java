...
public class AcademyWriteProService {

	public boolean registArticle(AcademyBean boardBean) {
...
//		Connection con = JdbcUtil.getConnection(); // static 메서드 호출 시
		...
		// => 글쓰기 작업을 위해 BoardDAO 객체의 insertArticle() 메서드 호출
		//    => 파라미터 : BoardBean 객체, 리턴값 : int타입 글 등록 성공에 대한 결과값

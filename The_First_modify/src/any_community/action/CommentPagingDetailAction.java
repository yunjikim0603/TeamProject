...
public class CommentPagingDetailAction implements Action {

	@Override
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		ActionForward forward = null;
		
		System.out.println("CommentPagingDetailAction");
		
		int post_num = Integer.parseInt(request.getParameter("post_num"));
//		int cmmnt_page = Integer.parseInt(request.getParameter("reply_page"));
		...
		int cmmnt_count = commentListService.getCommentListCount(post_num);
		//답글 페이지

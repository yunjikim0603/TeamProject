...
<%
	...
	int modify_num = (int)request.getAttribute("modify_num");
...
//                    output += "<div class='w3-border w3-padding'>";
	                 for (var j = 0; j < commentList[i].length; j++) {
	                    ...
	                    if(j === 0){
	                    	comment_num =parseInt(commentVar.comment_num);
	                    	...
	                    	var comment = commentVar.comment;
	                    	if(comment_num === modify_num){
	                    		modify_comment = comment;
	                    		alert(modify_comment);
	                    	}
...
// 	                    	alert(ss);
			...
			output += "<br><br><br><br>";
			output += "<form action='CmmntModifyPro.code?post_num="+post_num+"&comment_num="+modify_num+"' method='post'>";
			output += "<div><input type='text' name='nickname' value='"+session_nick+"' readonly></textarea>";
			output += "<textarea  name='comment' cols='60' rows='3' required=''>"+modify_comment+"</textarea></form>";
			output += "<input type='submit' class='btn btn-success btn-lg' value='수정'></div>";

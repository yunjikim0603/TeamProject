...
<body>
		...
		<div class="gtco-section">
			...
			<div class="center-box row">
							<!-- 게시물 목록 가져오기 -->
			<form action="AcademyModifyPro.ac" method="post" name="boardform" class="acdemy_wf">
				    ...
				    <input class="form-control" id="nickname" name="nickname" type="text" value="${sessionScope.nickname }" readonly=""></div>
						...
						<div class="form-group">
							  ...
							  <input class="form-control form-control-lg" type="text" value="${article.subject}" id="subject" name="subject">
						</div>
						...
						<div id="map" style="width: 100%; height: 100%; position: relative; overflow: hidden;"></div>
							<div id="menu_wrap" class="bg_white">
								<div class="option">
									<div>
										<div>
											키워드 : <input type="text" value="${article.academy_name }" id="keyword"
...
function removeAllChildNods(el) {   
	...
	<div class="wsr">
			학원주소 <input type="text" name="address" id="address" required="required" style="width:200px" readonly="readonly" value="${article.address}">
			학원명 <input type="text" name="academy_name" id="academy_name" required="required" style="width:200px" readonly="readonly" value="${article.academy_name}"><br><br>
